...
export function Footer() {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      href: 'https://github.com/alexispartac',
      icon: <GitHubIcon />,
    },
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/alexis-partac-b15b101b5/',
      icon: <LinkedInIcon />,
    },
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/mateialexis?igsh=MXR5ejNneThmMDRodg==',
      icon: <InstagramIcon />,
    },
  ];

  return (
    <footer className="relative z-10 bg-gradient-to-r from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900 border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="flex flex-col items-center justify-between md:flex-row">
          <div className="flex justify-center space-x-6 md:order-2">
            {socialLinks.map((item) => (
              ...
              >
                ...
                <span className="w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-shadow">
                  {item.icon}
                </span>
              </Link>
            ))}
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base text-gray-500 dark:text-gray-400">
              &copy; {currentYear} {language === 'en' ? 'All rights reserved.' : 'Toate drepturile rezervate.'}
            </p>
          </div>
        </div>
